...
- Get active (non-archived) report count
- Get archived report count
- Get all active reports with filtering and pagination
...
All four new endpoints are now available:

1. ✅ **GET /api/admin-reports/count/total** - Get total report count
2. ✅ **GET /api/admin-reports/count/active** - Get active report count
3. ✅ **GET /api/admin-reports/count/archived** - Get archived report count
4. ✅ **GET /api/admin-reports/active** - Get all active reports with filters
